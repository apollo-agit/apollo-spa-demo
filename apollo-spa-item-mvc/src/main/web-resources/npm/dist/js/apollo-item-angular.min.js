 ...
 * License: MIT
 */
apolloItemServices.factory("ApolloItems",["$resource",function(a){return a("http://localhost:8888/api/apollospaitems/spaitem",{id:"@id"},{query:{method:"GET",isArray:!0},save:{method:"POST"},remove:{method:"DELETE"}})}]);var removeTemplate='<input type="button" value="remove" ng-click="removeRow($index)" />',linkCellTemplate='<a ng-href="#/history/{{row.entity._id}}">{{row.entity._id}}</a>';apolloMaintenanceControllers.controller("ApolloItemMaintenanceController",["$scope","ApolloItems",function(a,b){a.apolloItems=b.query(),a.orderProp="apolloItemName",a.totalServerItems=a.apolloItems.length,a.gridOptions={data:"apolloItems",columnDefs:[{field:"_id",displayName:"Item Id",cellTemplate:linkCellTemplate},{field:"apolloItemName",displayName:"Item Name",enableCellEdit:!0},{field:"apolloItemAmount",displayName:"Item Cost",enableCellEdit:!0},{field:"apolloItemDesc",displayName:"Item Description",enableCellEdit:!0},{field:"remove",displayName:"",cellTemplate:removeTemplate}],showGroupPanel:!1,jqueryUITheme:!0,enablePaging:!1,showFooter:!0,enableCellSelection:!0,enableRowSelection:!0,plugins:[new ngGridFlexibleHeightPlugin({maxHeight:1e3})]},a.addRow=function(){a.apolloItems.push({apolloItemName:"Empty",apolloItemAmount:0})},a.saveAllApolloItems=function(){$.blockUI({message:'<h1><img src="images/busy.gif" /> Just a moment...</h1>'}),angular.forEach(a.apolloItems,function(a){b.save({id:a.id},a)}),setTimeout(function(){$.unblockUI()},2e3)},a.removeRow=function(){$.blockUI({message:'<h1><img src="busy.gif" /> Just a moment...</h1>'});var c=this.row.rowIndex,d=a.apolloItems[c];b.remove({id:d._id},d,function(){a.apolloItems=b.query()}),setTimeout(function(){$.unblockUI()},1e3)}}]),/**
 * @license Inertia v1.0
 * 
 * Inertia, Inc. 
 * License: MIT
 */
apolloItemServices.factory("ApolloNewItem",["$resource",function(a){return a("/service/apolloitems/item",{id:"@id"},{head:{url:"/service/apolloitems/item/metadata",method:"GET"},submit:{method:"POST"}})}]),apolloMaintenanceControllers.controller("ApolloNewItemController",["$scope","ApolloNewItem",function(a,b){var c=this;c.apolloItem={},c.submit=function(){b.submit({id:c.apolloItem.id},c.apolloItem).$promise.then(function(){c.apolloItem=result},function(a){alert(a)})},a.loadProperties=function(){b.head().$promise.then(function(a){c.formFields=apollo.generateFields(a)})}}]),/**
 * @license Inertia v1.0
 * 
 * Inertia, Inc. 
 * License: MIT
 */
apolloItemServices.factory("ApolloHistory",["$resource",function(a){return a("/service/apolloitems/history",{itemId:"@historyItemId"},{query:{method:"GET",isArray:!0}})}]),apolloMaintenanceControllers.controller("ApolloHistoryController",["$scope","$stateParams","ApolloHistory",function(a,b,c){a.historyItemId=b.itemId,a.itemHistory=c.query({itemId:a.historyItemId})}]),/**
 * @license Inertia v1.0
 * 
 * Inertia, Inc. License: MIT
 */
$(document).ajaxStop($.unblockUI),$(document).ready(function(){$(document).ready(function(){$("#saveAllItems").click(function(){$.blockUI({message:'<h1><img src="busy.gif" /> Just a moment...</h1>'})})})}),String.prototype.replaceAll=function(a,b){var c=this;return c.replace(new RegExp(a,"g"),b)};var apollo={generateFields:function(a){var b=0,c=new Array;return $.each(a.properties,function(a,d){var e=new Object;switch(e.templateOptions=new Object,e.key=a,d.type){case"string":e.type="input";break;case"text":e.type="textarea",e.templateOptions.rows=4,e.templateOptions.cols=15;break;case"id":e.type="input",e.templateOptions.disabled="true";break;default:e.type="input"}e.templateOptions.required=d.required,e.templateOptions.label=a.replaceAll("_"," "),c[b++]=e}),c}};