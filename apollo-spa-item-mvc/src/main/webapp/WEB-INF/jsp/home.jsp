	...
	<div class="row clearfix">
		<div class="jumbotron">
			<div class="container">
				...
				<p>This is the starting text for the Apollo Mobile stuff. Need to add verbiage that will describe the solution.</p>
				<p>
	...
	<div class="row clearfix">
		...
		<div class="container">
			...
			<div class="list-group">
					...
					<a href="#" class="list-group-item">
						<img src="<c:url value="/images/success.png"/>" alt="Apollo Success" class="img-responsive large-icon">
						<blockquote>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
								Integer posuere erat a ante.</p>
							<small>Someone famous <cite>Source Title</cite></small>
